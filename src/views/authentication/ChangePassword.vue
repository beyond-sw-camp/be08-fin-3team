                    ...
                    <v-card rounded="md" elevation="10" class="px-sm-1 px-0  mx-auto">
                        <v-card-item class="pa-sm-8">
                            ...
                            <v-col cols="12">
                                ...
                                <VTextField v-model="password" :counter="10" placeholder="비밀번호를 입력해주세요"
                                    :rules="passwordRules" required variant="outlined" type="password" color="primary">
                                </VTextField>
                                <v-label class="text-subtitle-1 font-weight-medium pb-2">비밀번호 확인</v-label>
                                <VTextField v-model="confirmPassword" :counter="10" placeholder="비밀번호를 입력해주세요"
                                    :rules="confirmPasswordRules" required variant="outlined" type="password"
                                    color="primary"></VTextField>
                                <v-btn size="large" class="mt-2 signup-btn" color="primary" block flat
                                    @click=changePassword>비밀번호 변경</v-btn>
                            </v-col>
